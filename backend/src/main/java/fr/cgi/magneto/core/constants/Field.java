...
public class Field {
    ...
    public static final String PARENTOWNER = "parentOwner";
    ...
    public static final String MAGNETO_PUBLISH_CONTEXT_PERIOD_IN_MS = "MAGNETO_PUBLISH_CONTEXT_PERIOD_IN_MS";
}
