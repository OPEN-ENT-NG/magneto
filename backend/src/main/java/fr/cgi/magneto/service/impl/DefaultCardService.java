                    ...
                    .project(new JsonObject()
                            ...
                            .put(Field.NBOFFAVORITES, new JsonObject()
                                    .put(Mongo.$COND, new JsonObject()
                                            ...
                                            .put(Mongo.ELSE, 0)))
                            .put(Field.ISLIKED, 1)
//                            .put(Field.OPENINNEWTAB, new JsonObject()
//                                    .put(Mongo.$COND, new JsonObject()
//                                            .put(Mongo.IF, new JsonObject()
//                                                    .put(Mongo.EXISTS, "$" + Field.OPENINNEWTAB))
//                                            .put(Mongo.THEN, new JsonObject()
//                                                    .put(Mongo.$COND, new JsonObject()
//                                                            .put(Mongo.IF, "$" + Field.OPENINNEWTAB)
//                                                            .put(Mongo.THEN, true)
//                                                            .put(Mongo.ELSE, false)))
//                                            .put(Mongo.ELSE, "$$REMOVE")))
                            .put(Field.OPENINNEWTAB, 1)
//                            .put(Field.OPENINNEWTAB, new JsonObject()
//                                    .put(Mongo.$COND, new JsonObject()
//                                            .put(Mongo.IF, new JsonObject()
//                                                    .put(Mongo.NOT, new JsonArray()
//                                                            .add(new JsonObject()
//                                                                    .put(Mongo.IFNULL, new JsonArray()
//                                                                            .add(String.format("$%s", Field.OPENINNEWTAB))
//                                                                            .add(true)))))
//                                            .put(Mongo.THEN, null)
//                                            .put(Mongo.ELSE, String.format("$%s", Field.OPENINNEWTAB))
//                                    )
//                            )
                    );
        }
