// vite.config.ts
import { defineConfig, loadEnv } from "file:///home/node/app/node_modules/.pnpm/vite@4.4.11_@types+node@20.8.5_sass@1.69.5/node_modules/vite/dist/node/index.js";
...
var vite_config_default = ({ mode }) => {
  ...
  const proxy = {
    ...
    "^/(?=auth|appregistry|cas|userbook|directory|communication|conversation|portal|session|timeline|workspace|infra)": proxyObj,
    "/blog": proxyObj,
    "/explorer": proxyObj,
    "todoapp": proxyObj,
    "/magneto": proxyObj
