...
public class CardPayload implements Model<CardPayload> {
    ...
    public CardPayload(JsonObject card) {
        ...
        this.resourceUrl = card.getString(Field.RESSOURCEURL);
        this.resourceType = card.getString(Field.RESSOURCETYPE);
    ...
    public CardPayload setResourceUrl(String resourceUrl) {
    ...
    public JsonObject toJson() {
        ...
        JsonObject json = new JsonObject()
                ...
                .put(Field.RESSOURCETYPE, this.getResourceType())
                .put(Field.RESSOURCEURL, this.getResourceUrl())
